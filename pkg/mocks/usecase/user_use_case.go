...
func (_m *UserUseCase) FindByID(ctx *fasthttp.RequestCtx, id uint) (domain.User, error) {
...
func (_m *UserUseCase) UpdateByID(ctx *fasthttp.RequestCtx, id uint, user domain.User) (domain.User, error) {
