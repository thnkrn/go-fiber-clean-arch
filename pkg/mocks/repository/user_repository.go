...
func (_m *UserRepository) Create(ctx *fasthttp.RequestCtx, user domain.User) (domain.User, error) {
...
func (_m *UserRepository) Delete(ctx *fasthttp.RequestCtx, user domain.User) error {
	ret := _m.Called(ctx, user)
...
func (_m *UserRepository) FindAll(ctx *fasthttp.RequestCtx) ([]domain.User, error) {
	ret := _m.Called(ctx)
...
func (_m *UserRepository) GetMatchName(ctx *fasthttp.RequestCtx, text string) ([]domain.User, error) {
